...
//			    
        ...
        $scope.editRecordModal = function (size) {
            ...
            var oldName = $scope.recordName;

            var setScope = function(newName, newDescription)
            {
                $scope.recordName = newName;
            ...
            var modalInstance = $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance, newRecord) {
                    // $scope.newRecord.title = $scope.recordName;
                    // $scope.newRecord.description = $scope.description;
            ...
            modalInstance.result.then(function () {
                // console.log(document.getElementById("rn").value);
                ...
                sendRequest.send(
                    'PATCH',
                    'records/' + $cookieStore.get('username') + '&' + oldName,
                    function (result) {
                        setScope(newName, newDescription);
                        getRecordList();
