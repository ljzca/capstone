    ...
    setStats = function () 
    {
        $scope.$apply(function () 
        {
            ...
            if ($scope.indexData != null)
            {
                ...
                $scope.fvelocity = $scope.indexData.fvelocity.toFixed(2) + " km/h";
                $scope.gratio = $scope.indexData.gratio;
                $scope.gvelocity = $scope.indexData.gvelocity.toFixed(2) + " km/h";
                ...
                $scope.vvelocity = $scope.indexData.vvelocity.toFixed(2) + " km/h";
